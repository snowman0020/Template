    ...
    public class Startup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<TemplateDbContext>(options =>
            {
                ...
                {
                    var connectionOracleServer = customSettingData.ConnectionOracleServer ?? "";

                    options.UseOracle(connectionOracleServer, s =>
                    {
                        s.MigrationsAssembly("Template.Infrastructure.Oracle");
                    });
                }
                else
                {
